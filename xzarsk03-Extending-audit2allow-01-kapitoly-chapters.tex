...
Testing \texttt{AccessVector.merge()}:
...
Testing \texttt{AccessVector.add\_av()}:
...
Testing \texttt{AccessVector.add()}:

This method just creates an instance of \texttt{AccessVector} class and passes
...
\begin{longtabu}{|l|X|} \hline
    ...
    \texttt{test\_policygen.py} module}
    \\ \hline
    \texttt{test\_set\_gen\_xperms()} & TODO
    \\ \hline
\end{longtabu}
...
\begin{longtabu}{|l|X|} \hline
    ...
    \texttt{test\_policygen.py} module}
    \\ \hline
    \texttt{test\_av\_rules()} & TODO
    \\ \hline
    \texttt{test\_ext\_av\_rules()} & TODO
    \\ \hline
\end{longtabu}
...
Testing \texttt{XpermSet} class:
\begin{longtabu}{|l|X|} \hline
    \multicolumn2{|l|}{\texttt{TestXpermSet} class from the
    \texttt{test\_refpolicy.py} module}
    \\ \hline
    \texttt{TestXpermSet.test\_init()} & TODO
    \\ \hline
    \texttt{TestXpermSet.test\_normalize\_ranges()} & TODO
    \\ \hline
    \texttt{TestXpermSet.test\_add()} & TODO
    \\ \hline
    \texttt{TestXpermSet.test\_extend()} & TODO
    \\ \hline
\end{longtabu}

Testing \texttt{AVExtRule} class:
\begin{longtabu}{|l|X|} \hline
    \multicolumn2{|l|}{\texttt{TestXpermSet} class from the
    \texttt{test\_refpolicy.py} module}
    \\ \hline
    \texttt{TestAVExtRule.test\_init()} & TODO
    \\ \hline
    \texttt{TestAVExtRule.test\_rule\_type\_str()} & TODO
    \\ \hline
    \texttt{TestAVExtRule.test\_from\_av()} & TODO
    \\ \hline
    \texttt{TestAVExtRule.test\_from\_av\_self()} & TODO
    \\ \hline
    \texttt{TestAVExtRule.test\_to\_string()} & TODO
    \\ \hline
\end{longtabu}
