...
\subsection{Representation of Extended Permission AV Rule}
...
\subsection{Storing Extended Permissions in Access Vectors}
...
\end{lstlisting}
(Note that the \texttt{other\_command} and \texttt{another\_command} operations
are made up as only the \texttt{ioctl} operation is supported as of policy
version 31.)
