...
Linux Security Module hooks calls security checks in SELinux. See figure
\ref{fig:dacmac}.

\begin{figure}
    \centering
    \label{fig:dacmac}
    \input{./figures/dac-mac.tex}
    % TODO: add "adapted from"?
    \caption{DAC and MAC checks.}
\end{figure}
...
Running SELinux in permissive is useful for catching AVC denials that can be
analyzes using the audit2allow utility. To perform single task (for example
...
access vector is then compared with default context. In case of difference,
