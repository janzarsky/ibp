...
\projectinfo{
  ...
  title.cs={Rozšíření nástroje audit2allow pro poskytování více omezujících řešení},  % název práce v češtině či slovenštině (dle zadání) / thesis title in czech language (according to assignment)
  title.en={Extending audit2allow to Provide More Restrictive Solutions}, % název práce v angličtině / thesis title in english
  title.length={14.3cm}, % nastavení délky bloku s titulkem pro úpravu zalomení řádku (lze definovat zde nebo níže) / setting the length of a block with a thesis title for adjusting a line break (can be defined here or below)
  %Autor / Author
  ...
  keywords.cs={SELinux, audit2allow, bezpečnost, mandatorní řízení přístupu}, % klíčová slova v českém či slovenském jazyce / keywords in czech or slovak language
  keywords.en={SELinux, audit2allow, security, mandatory access control}, % klíčová slova v anglickém jazyce / keywords in english
  % Abstrakt / Abstract
  ...
  pod vedením pana Ing. Aleše Smrčky, Ph.D.  Další informace mi poskytli Miloš
  Malík, Petr Lautrbach, Lukáš Vrabec a Vít Mojžíš.  Uvedl jsem všechny
...
% Rozšířený abstrakt (2-6 normostran) - lze definovat zde nebo výše / Extended abstract (approximately 3 standard pages) - can be defined here or above
