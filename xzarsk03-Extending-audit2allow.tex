...
\projectinfo{
    ...
    nástroje tak, aby poskytoval více ome\-zu\-jí\-cí a~bez\-peč\-něj\-ší řešení
    uživateli. Základní koncepty systému SELinux a~jeho bez\-peč\-nost\-ní
    po\-li\-ti\-ky jsou představeny. Rozebrány jsou situace, kdy nástroj
    audit2allow poskytuje ře\-še\-ní, kte\-rá jsou ne\-efek\-tivní a~potenciálně
    nebezpečná. Podpora pro generování pravidel udě\-lu\-jí\-cí roz\-ší\-ře\-ná
    oprávnění byla implementována. Základní podpora pro kontrolu
    bez\-peč\-nost\-ní\-ho kon\-tex\-tu souborů byla implementována.
    Implementační detaily a~testování obou roz\-ší\-ře\-ní nást\-ro\-je
    audit2allow jsou popsány.
    },
